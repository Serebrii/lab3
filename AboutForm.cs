...
namespace JSONDispatcher.Forms
{
    public partial class AboutForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.infoLabel.Size = new System.Drawing.Size(422, 104);
            this.infoLabel.TabIndex = 0;
            this.infoLabel.Text = "Лабораторна робота № 3. ДИСПЕТЧЕР ДЛЯ JSON.\n\nЛабораторну виконав: Серебрій Сергій" +
    "\nКурс: 2 курс;\nГрупа: К-25;\nРік навчання: 2024;\n\nОпис лабораторної: РОЗРОБКА ПРО" +
    "ГРАМ ОБРОБКИ ФАЙЛІВ У ФОРМАТІ JSON.";
